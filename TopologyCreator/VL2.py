...
def main_as_def():
    ...
    f = open('PathsVL264.txt', 'a')
    LS = open('LinksVL264.txt', 'a')
    FI = open('InPathsVL264.txt', 'a')
    FO = open('OutPathsVL264.txt', 'a')
    
    NoOfServers = 64
    NoOfServersPerToR = 16
    NoOfPods = 2
    TotEdgeSwitches = 4
    ...
    for s in range (1, MidSwitchesStarts):
        ...
        if s in servers1:
            ...
            l = str(EdgeSwitchesStart+2) + "-" + str(MidSwitchesStarts+4) + "," + str(MidSwitchesStarts+4) + "-" + str((MidSwitchesStarts + 4) + 2) + "," + str((MidSwitchesStarts + 4) + 2) + "-" + str(s)
            FI.write(l)
            FI.write('\n')
        elif s in servers4:
            l = str(EdgeSwitchesStart+2) + "-" + str(MidSwitchesStarts+4) + "," + str(MidSwitchesStarts+4) + "-" + str((MidSwitchesStarts + 4) + 3) + "," + str((MidSwitchesStarts + 4) + 3) + "-" + str(s)
            FI.write(l)
            FI.write('\n')
    FI.close()
    ...
    for s in range (1, MidSwitchesStarts):
        ...
        if s in servers1:
            ...
            l = str(EdgeSwitchesStart+3) + "-" + str(MidSwitchesStarts+5) + "," + str(MidSwitchesStarts+5) + "-" + str((MidSwitchesStarts + 5) + 1) + "," + str((MidSwitchesStarts + 5) + 1) + "-" + str(s)
            FO.write(l)
            FO.write('\n')
        elif s in servers4:
            l = str(EdgeSwitchesStart+3) + "-" + str(MidSwitchesStarts+5) + "," + str(MidSwitchesStarts+5) + "-" + str((MidSwitchesStarts + 5) + 2) + "," + str((MidSwitchesStarts + 5) + 2) + "-" + str(s)
            FO.write(l)
            FO.write('\n')
